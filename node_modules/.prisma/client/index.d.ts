...
export type StoreSelect = {
  ...
  province?: boolean
  receipts?: boolean | FindManyReceiptArgs
  Produce?: boolean | FindManyProduceArgs
}
...
export declare class Prisma__StoreClient<T> implements Promise<T> {
  ...
  Produce<T extends FindManyProduceArgs = {}>(args?: Subset<T, FindManyProduceArgs>): CheckSelect<T, Promise<Array<Produce>>, Promise<Array<ProduceGetPayload<T>>>>;
...
export type ProduceCreateInput = {
  ...
  price: number
  foodtype: string
  store: StoreCreateOneWithoutProduceInput
...
export type ProduceUpdateInput = {
  ...
  store?: StoreUpdateOneRequiredWithoutProduceInput
...
export type StoreCreateInput = {
  ...
  Produce?: ProduceCreateManyWithoutStoreInput
}
...
export type StoreUpdateInput = {
  ...
  Produce?: ProduceUpdateManyWithoutStoreInput
}
...
export type StoreCreateOneWithoutProduceInput = {
  create?: StoreCreateWithoutProduceInput
...
export type StoreUpdateOneRequiredWithoutProduceInput = {
  create?: StoreCreateWithoutProduceInput
  connect?: StoreWhereUniqueInput
  update?: StoreUpdateWithoutProduceDataInput
  upsert?: StoreUpsertWithoutProduceInput
}
...
export type StoreCreateWithoutProduceInput = {
  name: string
  address: string
  email: string
  storeowner: string
...
export type StoreUpdateWithoutProduceDataInput = {
  name?: string | StringFieldUpdateOperationsInput
  address?: string | StringFieldUpdateOperationsInput
  email?: string | StringFieldUpdateOperationsInput
  storeowner?: string | StringFieldUpdateOperationsInput
...
export type StoreUpsertWithoutProduceInput = {
  update: StoreUpdateWithoutProduceDataInput
  create: StoreCreateWithoutProduceInput
}
