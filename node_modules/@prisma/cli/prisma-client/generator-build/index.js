      ...
      try {
        ...
        if (enableExperimental) {
          enableExperimental = enableExperimental.filter((f) => {
            ...
            return true;
          }).filter((e) => !["middlewares", "aggregateApi", "distinct", "aggregations"].includes(e));
        }
...
var require_dist4 = __commonJS((exports2, module2) => {
  module2.exports = function klona3(x) {
    if (typeof x !== "object")
      return x;
...
var require_package = __commonJS((exports2, module2) => {
  module2.exports = {
    ...
    prisma: {
      version: "e6c9b4b2b7fa162d0d459d1863321f547498fcfe"
    },
    files: [
      "runtime",
      "scripts",
...
class TSClient {
  constructor(options) {
    ...
    this.dmmf = new DMMFClass(klona.default(options.document));
  }
  toJS() {
    const {
      generator,
...
${actionName}<T extends ${getModelArgName(name, actionName)}>(
  args${actionName === generator_helper.DMMF.ModelAction.findMany ? "?" : ""}: Subset<T, ${getModelArgName(name, actionName)}>
